...
public class DispositivoConectado {
    ...
    //Constructor
    public DispositivoConectado(int idDispositivo, String nameDevice, LocalDate dateDevice, LocalTime timeDevice, int idConfiguracion) {
    ...
    public LocalDate getDateDevice() {return dateDevice;}
    public LocalTime getTimeDevice() {return timeDevice;}
    ...
    public void setDateDevice(LocalDate dateDevice) {this.dateDevice = dateDevice;}
    public void setTimeDevice(LocalTime timeDevice) {this.timeDevice = timeDevice;}
