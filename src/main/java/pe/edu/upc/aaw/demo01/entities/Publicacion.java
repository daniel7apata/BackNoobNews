...
public class Publicacion {
    ...
    //Constructor
    public Publicacion(int idPublicacion, String headline, String lead, String body, int idCategoria, int attachedFile, LocalDate dateNews, LocalTime timeNews, boolean popular, int idUsuario) {
    ...
    public int getAttachedFile() {return attachedFile;}
    public LocalDate getDateNews() {return dateNews;}
    public LocalTime getTimeNews() {return timeNews;}
    ...
    public void setAttachedFile(int attachedFile) {this.attachedFile = attachedFile;}
    public void setDateNews(LocalDate dateNews) {this.dateNews = dateNews;}
    public void setTimeNews(LocalTime timeNews) {this.timeNews = timeNews;}
