...
public class Publication {
    ...
    public Publication(int idPublication, String headline, String lead, String body, String attachedFile, LocalDate dateNews, LocalTime timeNews, boolean popular, Users user) {
